							...
							<td>
								...
								<ul class="index-list">
									<li class="left box light-box">
										<div class="hudson">
											<form name="myform" action="/hello" method="post">
												<p>
													<input type="text" name="txtvalue" id="txtvalue"> <span
														onclick="document.myform.submit();
"> <a
															class="call-action text-l">» Go Go Go !!!</a> </span>
												</p>
											</form>
										</div></li>
								</ul></td>
 ...
 --%> 
	...
	<div id="cb-footer" class="cb-hf clearfix">
		<ul id="footer-nav" class="clearfix">
			...
			<li><a href="http://www.cloudbees.com/status.cb">Status</a>
			</li>
			<li><a href="http://www.cloudbees.com/security.cb">Security</a>
			</li>
